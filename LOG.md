...
|-------|-----------|-------------|--------|-------|
| 08/06/2026 | Creación del repositorio | Juan Angel Torres Florez | Completado | Repositorio inicializado en GitHub |
| 08/06/2026 | Definición de objetivos | Equipo completo | Completado | Integración de APIs DummyJSON y FakeStore |
| 08/06/2026 | Creación de documentación base | Jennifer Viviana Samper Torbello | Completado | README.md y WORKBOOK.md creados |
| 08/06/2026 | Configuración inicial del proyecto | Brayan | Completado | package.json y dependencias instaladas |
| 08/06/2026 | Creación de estructura de carpetas | Carolina | Completado | Estructura base del proyecto organizada |
| 08/06/2026 | Creación de archivo TSP.md | Juan Angel Torres Florez | Completado | Documentación de metodología del equipo |

### Semana 2 - Desarrollo y Ejemplos
...
| Fecha | Actividad | Responsable | Estado | Notas |
|-------|-----------|-------------|--------|-------|
| 15/06/2026 | Desarrollo de módulo DummyJSON completo | Carolina | Pendiente | Plazo 15/06/2026 |
...
## Resumen de Actividades por Participante

### Carolina
- Creación de estructura de carpetas
- Desarrollo de ejemplos DummyJSON
- Contribución a documentación inicial
...
- Desarrollo de ejemplos FakeStore API
- Actividades totales completadas: 4

### Jennifer Viviana Samper Torbello
- Creación de documentación base (README.md)
- Creación de WORKBOOK.md completo
- Documentación de endpoints de APIs
- Documentación de tabla de contenidos
- Actividades totales completadas: 4

### Juan Angel Torres Florez
- Creación del repositorio GitHub
- Definición de objetivos del proyecto
- Creación de documentación TSP.md
...
1. El equipo se ha organizado correctamente desde el inicio
2. La documentación está bien estructurada y accesible
